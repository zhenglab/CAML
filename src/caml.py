...
class CAML():
    ...
    def train(self):
        ...
        while(keep_training):
            ...
            for it in train_loader:
                ...
                self.writer.add_scalars('Global_Discriminator', {'domaink': d_loss}, epoch)
                self.writer.add_scalars('Contaminated_Discriminator', {'domaink': d_p_loss}, epoch)
    ...
    def sample(self):
        ...
        images = stitch_images(
            ...
            self.postprocess(mask_soft),
            self.postprocess(mask_pred),
